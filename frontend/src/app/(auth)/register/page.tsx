  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold tracking-tight text-zinc-100">Create an account</h1>
        <p className="text-sm text-zinc-400">Get started with your interactive quizzes</p>
      </div>
